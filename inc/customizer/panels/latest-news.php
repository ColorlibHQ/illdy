...
$wp_customize->add_section(
	$prefix . '_latest_news_general', array(
...
// Title
$wp_customize->add_setting(
	$prefix . '_latest_news_general_title', array(
...
// Button Text
$wp_customize->add_setting(
	$prefix . '_latest_news_button_text', array(
...
// Background Image
$wp_customize->add_setting(
	$prefix . '_latest_news_general_image', array(
...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		$wp_customize, $prefix . '_latest_news_general_image', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_background_position_x', array(
		'default'           => 'center',
		'sanitize_callback' => 'esc_html',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_setting(
	$prefix . '_latest_news_background_position_y', array(
		'default'           => 'center',
		'sanitize_callback' => 'esc_html',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Background_Position_Control(
		$wp_customize, $prefix . '_latest_news_background_position', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_background_size', array(
		'default'           => 'cover',
...
// Background Color
$wp_customize->add_setting(
	$prefix . '_latest_news_general_color', array(
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_general_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_title_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#fff',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_title_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_descriptions_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#fff',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_descriptions_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_button_background', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#f1d204',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_button_background', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_button_background_hover', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#6a4d8a',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_button_background_hover', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_button_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#fff',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_button_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_post_bakground_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#fff',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_post_bakground_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_post_text_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#5e5e5e',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_post_text_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_post_text_hover_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#f1d204',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_post_text_hover_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_post_content_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#8c9597',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_post_content_color', array(
...
$wp_customize->add_setting(
	$prefix . '_latest_news_post_button_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#f1d204',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_post_button_color', array(
			'label'    => __( 'Blog Button Background Color', 'illdy' ),
			'section'  => $prefix . '_latest_news_general',
...
$wp_customize->add_setting(
	$prefix . '_latest_news_post_button_hover_color', array(
		'sanitize_callback' => 'sanitize_hex_color',
		'default'           => '#6a4d8a',
		'transport'         => 'postMessage',
	)
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		$wp_customize, $prefix . '_latest_news_post_button_hover_color', array(
			'label'    => __( 'Blog Button Hover Background Color', 'illdy' ),
			'section'  => $prefix . '_latest_news_general',

...
/******************* General *******************/
/***********************************************/
$wp_customize->add_section( $prefix . '_latest_news_general' , array(
...
// Show this section
$wp_customize->add_setting( $prefix . '_latest_news_general_show', array(
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 1,
	'transport'         => 'postMessage',
) );
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_latest_news_general_show', array(
	'type'      => 'epsilon-toggle',
...
// Title
$wp_customize->add_setting( $prefix . '_latest_news_general_title', array(
	'sanitize_callback' => 'illdy_sanitize_html',
	'default'           => __( 'Latest News', 'illdy' ),
	'transport'         => 'postMessage',
) );
$wp_customize->add_control( $prefix . '_latest_news_general_title', array(
...
if ( get_theme_mod( $prefix . '_latest_news_general_entry' ) ) {
	...
	$wp_customize->add_control( new Illdy_Text_Custom_Control( $wp_customize, $prefix . '_latest_news_general_entry', array(
...
// Button Text
$wp_customize->add_setting( $prefix . '_latest_news_button_text', array(
	'sanitize_callback' => 'sanitize_text_field',
	'default'           => __( 'See blog', 'illdy' ),
	'transport'         => 'postMessage',
) );
$wp_customize->add_control( $prefix . '_latest_news_button_text', array(
...
// Number of posts
$wp_customize->add_setting( $prefix . '_latest_news_number_of_posts', array(
	'sanitize_callback' => 'sanitize_text_field',
	'default'           => 3,
) );

$wp_customize->add_control( new Epsilon_Control_Slider( $wp_customize, $prefix . '_latest_news_number_of_posts', array(
...
$wp_customize->add_control( new Epsilon_Control_Slider( $wp_customize, $prefix . '_latest_news_words_number', array(
...
$wp_customize->add_control(  new Epsilon_Control_Tab( $wp_customize, $prefix . '_latest_news_tab', array(
	'type'      => 'epsilon-tab',
	'section'   => $prefix . '_latest_news_general',
	'buttons'   => array(
		array(

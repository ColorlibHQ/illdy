...
// Show this section
$wp_customize->add_setting( $prefix . '_projects_general_show', array(
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 1,
	'transport'         => 'postMessage',
) );
$wp_customize->add_control(  new Epsilon_Control_Toggle( $wp_customize, $prefix . '_projects_general_show', array(
	'type'      => 'epsilon-toggle',
	'label'     => __( 'Show this section?', 'illdy' ),
	'section'   => $panel_id,
	'priority'  => 1,
) ) );
$wp_customize->add_setting( $prefix . '_projects_lightbox', array(
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 0,
	'transport'         => 'postMessage',
) );
$wp_customize->add_control(  new Epsilon_Control_Toggle( $wp_customize, $prefix . '_projects_lightbox', array(
	'type'      => 'epsilon-toggle',
...
// Title
$wp_customize->add_setting( $prefix . '_projects_general_title', array(
	'sanitize_callback' => 'illdy_sanitize_html',
	'default'           => __( 'Projects', 'illdy' ),
	'transport'         => 'postMessage',
) );
$wp_customize->add_control( $prefix . '_projects_general_title', array(
...
if ( get_theme_mod( $prefix . '_projects_general_entry' ) ) {
	...
	$wp_customize->add_setting( $prefix . '_projects_entry_text', array(
		'sanitize_callback' => 'esc_html',
		'default'           => '',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( new Illdy_Text_Custom_Control( $wp_customize, $prefix . '_projects_entry_text', array(
...
$wp_customize->add_setting( $prefix . '_projects_widget_button', array(
	'transport'         => 'postMessage',
	'sanitize_callback' => 'wp_kses_post',
) );
$wp_customize->add_control( new Epsilon_Control_Button( $wp_customize, $prefix . '_projects_widget_button', array(
...
$wp_customize->add_control( new Epsilon_Control_Tab( $wp_customize, $prefix . '_projects_tab', array(
	'type'      => 'epsilon-tab',
	'section'   => $panel_id,
	'buttons'   => array(
		array(

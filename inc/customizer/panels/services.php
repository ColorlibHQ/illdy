...
if ( get_theme_mod( $prefix . '_services_general_entry' ) ) {
	...
	$wp_customize->add_setting( $prefix . '_services_entry_text', array(
		'sanitize_callback' => 'esc_html',
		'default'           => '',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( new Illdy_Text_Custom_Control( $wp_customize, $prefix . '_services_entry_text', array(
...
$wp_customize->add_setting( $prefix . '_services_widget_button', array(
	'transport'         => 'postMessage',
	'sanitize_callback' => 'wp_kses_post',
) );
$wp_customize->add_control( new Epsilon_Control_Button( $wp_customize, $prefix . '_services_widget_button', array(
...
$wp_customize->add_control(  new Epsilon_Control_Tab( $wp_customize, $prefix . '_services_tab', array(
	'type'      => 'epsilon-tab',
	'section'   => $panel_id,
	'buttons'   => array(
		array(

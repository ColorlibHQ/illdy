...
$wp_customize->add_control( new Epsilon_Control_Button( $wp_customize, $prefix . '_testimonial_widget_button', array(
...
$wp_customize->add_control(  new Epsilon_Control_Tab( $wp_customize, $prefix . '_testimonials_tab', array(
	'type'      => 'epsilon-tab',
	'section'   => $panel_id,
	'buttons'   => array(
		array(

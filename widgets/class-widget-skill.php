...
add_action( 'admin_print_scripts-widgets.php', 'illdy_enqueue_script_farbtastic_skill' );
function illdy_enqueue_script_farbtastic_skill() {
    wp_enqueue_script( 'farbtastic' );
}

add_action( 'admin_print_styles-widgets.php', 'illd_enqueue_style_farbtastic_skill' );
function illd_enqueue_style_farbtastic_skill() {
